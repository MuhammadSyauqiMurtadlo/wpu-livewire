<div class="flex justify-center gap-10">
    <div class="w-1/3 my-10">
        <div class="py-2">
            <div class="mx-auto">
                <h2 class="mt-8 text-center text-2xl/9 font-bold tracking-tight text-gray-900">Create New User</h2>
            </div>
            ...
            <div class="mt-4">
                <form wire:submit.prevent="createNewUser" class="space-y-6">
                    ...
                    <div wire:loading wire:target="avatar"
                        class="flex items-center justify-center h-32 w-32 border border-blue-900 rounded-lg bg-blue-100">
                        <div
                            class="px-1 py-2 ring-1 ring-inset text-[10px] font-medium leading-none text-center text-blue-800 bg-blue-200 rounded-full animate-pulse">
                            loading...</div>
                    </div>

                    @if ($avatar)
                        <div class="mt-4">
                            <p class="text-sm/6 font-medium text-gray-900">Preview:</p>
                            <img src="{{ $avatar->temporaryUrl() }}" alt="Avatar Preview"
                                class="mt-2 h-32 w-32 rounded-full block object-cover">
                        </div>
                    @endif
                    <div>
                        <button
